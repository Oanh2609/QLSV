...
namespace QLSV.Controllers
{
    public class LopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaLop,TenLop,MaKhoa,MaHeDT,MaKhoaHoc")] Lop lop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaLop,TenLop,MaKhoa,MaHeDT,MaKhoaHoc")] Lop lop)
        {
            if (ModelState.IsValid)
            {
